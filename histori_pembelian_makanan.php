    ...
    <?php 
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
            ...
            while($dt_makanan=mysqli_fetch_array($qry_makanan)){
                $makanan_dibeli.="<li>".$dt_makanan['nama_makanan']."</li>";
            }
            $makanan_dibeli.="</ol>";
            ...
            if(mysqli_num_rows($qry_cek_datang)>0){
                ...
                $hutang="hutang Rp. ".$dt_datang['hutang'];
                $status_datang="<label class='alert alert-success'>Sudah datang <br>".$hutang."</label>";
                $button_datang="";
            } else {
        ...
        <tr style="color: #FFEBC9">
            ...
            <td style = "text-align: center;"><a href="cetak-makanan.php?id=<?php echo $dt_histori['id_pembelian_makanan'] ?>" target="_blank" class="btn btn-sm btn-secondary">Cetak</a></td>
            <td><?=$button_datang?></td>            
        </tr>
        <?php
        }
